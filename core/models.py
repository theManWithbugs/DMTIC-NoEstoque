...
class MaterialObj(models.Model): 
    ...
    def __str__(self):
        return f" -{self.marca}-  ( {self.modelo} )  {self.contrato} "
...
class Contrato(models.Model):
    ...
    data_abert = models.DateField(blank=False, null=False, default=date.today, verbose_name='Data de abertura do contrato ') 
