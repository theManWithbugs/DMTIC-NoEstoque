...
function reg_unidade() {
    ...
    unidade_el.classList.add('animate__animated', 'animate__fadeInLeft');
...
function reg_departmento() {
    ...
    align-items: center; justify-content: center; display: flex; padding: 20px;`;
    departamento_el.classList.add('animate__animated', 'animate__fadeInLeft');
...
function reg_divisao() {
    ...
    align-items: center; justify-content: center; display: flex; padding: 20px;`;
    divisao_el.classList.add('animate__animated', 'animate__fadeInLeft');
